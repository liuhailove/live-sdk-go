...
type RTCEngine struct {
	...
	OnRestarting            func()
	OnRestarted             func(response *livekit.JoinResponse)
	OnResuming              func()
	OnResumed               func()
}
...
func NewRTCEngine() *RTCEngine {
	...
	e.client.OnSpeakersChanged = func(si []*livekit.SpeakerInfo) {
		if f := e.OnActiveSpeakersChanged; f != nil {
			f(si)
		}
	}
...
func (e *RTCEngine) dataPubChannelReady() bool {
	...
	return e.reliableDC.ReadyState() == webrtc.DataChannelStateOpen && e.lossyDCSub.ReadyState() == webrtc.DataChannelStateOpen
}
